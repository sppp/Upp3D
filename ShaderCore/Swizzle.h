#ifndef __SHADERCORE_SWIZZLE_H
#define __SHADERCORE_SWIZZLE_H

#define SWIZZLE_OP(TYPE, SWIZZLE) inline TYPE SWIZZLE () const { TYPE result; result.SetType(Temporary); result.temp_init = xs("%.%", Definition(), SwizzleExtension(Swizzle::SWIZZLE)); return result; }
...
inline String SwizzleExtension(Swizzle swizzle) {
	switch (swizzle) {
	case Swizzle::x:
		return "x";
	case Swizzle::y:
