#ifndef __SHADERCORE_VEC_DETAIL_H
#define __SHADERCORE_VEC_DETAIL_H
...
template <typename vec_detail> class generic_vec2;
template <typename vec_detail> class generic_vec3;
template <typename vec_detail> class generic_vec4;
template <typename detail> class generic_sampler2D;
